...
public class MecBot {
    ...
    public MecBot (MotorType mType, float w, float l, float wheelDiam, float rollerAngle, float gearRatio, BNO055Enhanced.AxesMap axesMap,
                   BNO055Enhanced.AxesSign axesSign){
        MOTOR_TYPE = mType;
    ...
    public void init(HardwareMap hwMap) {
        ...
        imu = hwMap.get(BNO055IMUEnhanced.class, "imu");

        /*
         * TODO: Make this a BNO055Enhanced.Parameters, and use the appropriate axes map and sign
         */
        BNO055IMUEnhanced.Parameters parameters = new BNO055IMUEnhanced.Parameters();
        parameters.accelerationIntegrationAlgorithm = null;
        parameters.accelUnit = BNO055IMUEnhanced.AccelUnit.METERS_PERSEC_PERSEC;
        parameters.angleUnit = BNO055IMUEnhanced.AngleUnit.DEGREES;
